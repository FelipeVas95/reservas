...
<div class="container-fluid">
    <div class="row flex-nowrap" style="height: auto;">
        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white" style="height: calc(100vh - 60px - 65px);">
                ...
                <div class="collapse d-md-block" id="sidebarMenu">
                    ...
                    @endphp
                        ...
                        <span class="fs-5 d-none d-sm-inline"><a class="navbar-brand" href="{{ route('home') }}">{{$rol}}</a></span>
                    </a>
                    <hr>
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            <a href="#submenu1" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                                <i class="fa-solid fa-gears"></i> <span class="ms-1 d-none d-sm-inline">Reservas</span>
                            </a>
                        ...
                        <li>
                            <a href="{{ route('workspaces.index') }}" class="nav-link px-0 align-middle">
                                <i class="fa-regular fa-building"></i> <span class="ms-1 d-none d-sm-inline">Salas</span>
                            </a>
                        </li>
                        @endcan
                    </ul>
